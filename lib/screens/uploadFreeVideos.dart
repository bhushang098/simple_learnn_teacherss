...
class UploadFreeVideos extends StatefulWidget {
  @override
  _UploadFreeVideosState createState() => _UploadFreeVideosState();
}

class _UploadFreeVideosState extends State<UploadFreeVideos> {
...
//    course.document()
  ...
  void navToUploadPaidVid(ScreenArgs args) {
    Navigator.pushNamed(context, '/UploadPaidVid', arguments: args);
  }
}
