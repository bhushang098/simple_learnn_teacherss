...
class AddInCourse extends StatefulWidget {
  @override
  _AddInCourseState createState() => _AddInCourseState();
}

class _AddInCourseState extends State<AddInCourse> {
  ...
  void showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
          "Added new videos in your Course \nsee this changes in your Course option"),
      actions: [
        okButton,
      ],
    );
